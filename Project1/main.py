...
portalPath = "./textures/portal/portal"
portalImages = [portalPath + str(p) + ".png" for p in range(0, 5)]
...
while not gameOver:
    ...
    for orb in orbsList:
        ...
        displaySurface.blit(orb.image, (orb.position[0] * tileSize, orb.position[1] * tileSize))
    ...
    displaySurface.blit(enemy.enemy, (enemy.enemyPosition[0] * tileSize, enemy.enemyPosition[1] * tileSize))
